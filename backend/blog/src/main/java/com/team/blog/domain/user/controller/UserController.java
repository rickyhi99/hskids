...
import com.team.blog.domain.user.dto.UserProfileImgDto;
import com.team.blog.domain.user.dto.UserPublicResponse;
...
public class UserController {
    ...
    public ResponseEntity<ApiResponse<Void>> updateProfileImg(Authentication auth,
                                                              @RequestBody UserProfileImgDto dto) {
        userService.updateProfileImg(auth.getName(), dto.getProfileImg());
        return ResponseEntity.ok(ApiResponse.success(SuccessCode.SUCCESS_OK));
    }
    ...
    public ResponseEntity<ApiResponse<UserPublicResponse>> getUserById(@PathVariable Long userId) {
        return ResponseEntity.ok(ApiResponse.success(new UserPublicResponse(userService.findById(userId))));
    }
